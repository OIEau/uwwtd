...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php
    ...
    if ($view_mode == 'full' && !empty($title)){
       print '<h1>'.$node->title.' <small><i>- '.$nodetype.', '.t('reporting year: ').$node->field_anneedata['und'][0]['value'].'</i></small></h1><br>';
    }
    ...
    if($histories != false){
      $otherList = array();
      print '<div class="uwwtd-history">';
      print '<fieldset class="uwwtd-history field-group-fieldset panel panel-default form-wrapper">
      ...
      foreach($otherList as $other){
        ...
        if($ting->field_anneedata['und'][0]['value'] == $node->field_anneedata['und'][0]['value']){
          print '<div class="uwwtd-history-element uwwtd-history-element-current">';
            print '<h4>'.$ting->field_anneedata['und'][0]['value'].'</h4>';
          print '</div>';
        }
        else{
          print '<div class="uwwtd-history-element">';
            print '<h4>'.l($ting->field_anneedata['und'][0]['value'], 'node/'.$ting->nid).'</h4>';
          print '</div>';
       }
      }
      print '</fieldset></div><br>';
    }
    // END TIMELINE
